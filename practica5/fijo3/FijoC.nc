...
implementation {
	...
	event void Timer0.fired() {
		...
		if (!busy) {
			...
			pktfijo_tx->ID_fijo = FIJO3_ID;		// Campo 1: ID fijo 1
			pktfijo_tx->medidaRssi = rssi;      // Campo 2: Medida RSSI
			pktfijo_tx->x = COOR3_X;  			// Campo 3: Coordenada X
			pktfijo_tx->y = COOR3_Y;			// Campo 4: Coordenada Y
